...
function Register() {
  return (
    ...
    <div className=' w-full max-w-2xl  '>
      <h3 className='text-xl text-center font-bold text-black capitalize mb-2 '>register here</h3>
      <form action="" className='flex flex-col justify-center items-center bg-white shadow-xl rounded px-8 pt-6 pb-8 mb-4 z-50 ' >
        ...
        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 mb-1 text-gray-900 leading-tight focus:outline-none focus:shadow-outline" id="username"  />
        <label htmlFor="lastName" className="text-sm capitalize font-bold mb-2">last name</label>
        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 mb-1 text-gray-900 leading-tight focus:outline-none focus:shadow-outline" />
        ...
        <p className="text-sm font-medium capitalize">have an account? <Link to="/login" className="font-bold underline">log in here</Link> </p> 
      </form>
